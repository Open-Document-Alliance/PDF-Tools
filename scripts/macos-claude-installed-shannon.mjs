...
try {
  ...
  assert(tools.tools.length === 57, `Expected 57 installed tools, received ${tools.tools.length}`);
  assert(
  ...
  for (let startPage = 1; startPage <= EXPECTED_PAGE_COUNT; startPage += PAGE_SPAN) {
    ...
    assert(value.renderer?.version === "1.21.0", "Installed Markdown renderer version differs");
